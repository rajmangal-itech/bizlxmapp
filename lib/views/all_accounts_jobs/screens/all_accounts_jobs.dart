...
import 'package:bizlx_app/views/all_accounts_jobs/widgets/all_jobs_section.dart';
import 'package:flutter/material.dart';

class AllAccountJobs extends StatelessWidget {
  const AllAccountJobs({super.key});
