...
import '../DealsScreenview/deals_screen.dart';


class DealDisplay extends StatefulWidget {
  const DealDisplay({Key? key}) : super(key: key);

  @override
  State<DealDisplay> createState() => _DealDisplayState();
}

class _DealDisplayState extends State<DealDisplay> {
                ...
                Row(
                  children: [
                    ...
                    Container(
                      child: IconButton(
                        onPressed: () {
                          Navigator.push(context,MaterialPageRoute(builder: (context)=>const DealsScreen()));
                        },
                        icon: Icon(
                          Icons.navigate_next,
